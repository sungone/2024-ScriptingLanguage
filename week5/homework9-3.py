...
class MainGUI :
    def display(self) :
        ...
        if self.filled.get() == 1: ##채워?
            if self.v.get() == 1: ##직사각형?
                self.canvas.create_rectangle(width / 2 - width * 0.4 , height / 2 - height * 0.4 , width / 2 + width * 0.4 , height / 2 + height * 0.4 , fill='red' , tags = 'shape')
                
            else :
                self.canvas.create_oval(width / 2 - width * 0.4 , height / 2 - height * 0.4 , width / 2 + width * 0.4 , height / 2 + height * 0.4 , fill='red' , tags = 'shape')
        else :
            if self.v.get() == 1: ##직사각형?
